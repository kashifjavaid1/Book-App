...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className={` dark:bg-slate-800 dark:text-white md:mx-20 px-4 overflow-hidden fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? " bg-base-100 dark:bg-slate-600 dark:text-white"
        ...
        <div className="navbar bg-base-100 dark:bg-slate-800 dark:text-white">
          ...
          <div className="navbar-end space-x-3">
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal px-1 text-lg">{Navbar}</ul>
            </div>
            <div className="hidden md:block">
              <label className="px-3 py-2 border rounded-md flex items-center gap-2 dark:border-slate-700">
                <input
                  type="text"
